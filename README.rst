...
This will run it once, But in order to keep runing this, Open the terminal in the searxng directory and run `make run` this command should run the project!
